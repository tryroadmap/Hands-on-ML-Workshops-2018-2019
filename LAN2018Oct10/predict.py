...
# python predict.py --image images/cat.jpg --model output/simple_nn_lotusx_c.model --label-bin output/simple_nn_lb_lotusx_c.pickle --width 32 --height 32 --flatten 1
